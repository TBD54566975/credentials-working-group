...
* Propose ideas in our [discussion forums](https://forums.tbd.website/c/self-sovereign-identity-users/credentials-working-group/6)
* Raise an issue or feature request in our [issue tracker](https://github.com/TBD54566975/credentials-working-group/issues)
...
Anyone from the community is welcome (and encouraged!) to raise issues via [GitHub Issues](https://github.com/TBD54566975/credentials-working-group/issues).

### Discussions

Design discussions and proposals take place on [GitHub Discussions](https://forums.tbd.website/c/self-sovereign-identity-users/credentials-working-group/6).
